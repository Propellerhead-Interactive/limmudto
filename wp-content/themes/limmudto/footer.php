							...
							<div class="container">
								<div class="row">
									<div class="col-sm-12 text-center">
										<h1 class="text-white">Want to go to Limmud Toronto 2016? <a href="https://limmudto2016.eventbrite.ca/">Get Tickets!</a></h1>
									</div>
								</div><!--end of row-->
					...
					<div class="row">
						...
						<div class="col-sm-4 col-sm-offset-1">
							<ul class="contact-methods">
								<li><i class="icon pe-7s-mail"></i><span>volunteer@limmud.ca</span></li>
								<li><i class="icon pe-7s-phone"></i><span>1-647-343-6602</span></li>
